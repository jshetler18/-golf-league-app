...
export default function WeeklyScoring({seasonId,teams,scoreCap}:{seasonId:string;teams:Team[];scoreCap:number}){
 ...
 async function syncCompletedWeek4(){
   ...
   const scoreMap=new Map((s||[]).map((x:any)=>[x.team_id,Math.min(Number(x.official_total),scoreCap)]))
   let completed=0
