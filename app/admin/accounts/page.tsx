...
type Profile={id:string;full_name:string;email:string|null;status:string;booking_enabled:boolean;created_at:string;player_id:string|null;is_scorecard_official:boolean}
