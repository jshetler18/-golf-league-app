...
const cards=[
  ...
  {href:'/admin/meeting-rsvp',icon:'✅',title:'RSVP',text:'Create meeting RSVP links, copy a text message, and track who is coming.'},
  ...
  {href:'/admin/simulator',icon:'🖥️',title:'Simulator Bookings',text:'See upcoming reservations and add league or blocked simulator time.'}
]
