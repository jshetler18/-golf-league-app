            ...
            {section.heading.trim().toLowerCase().includes('tee assignment')&&<div className="tee-speed-table-wrap-v1334">
              ...
              <div className="table-wrap"><table className="tee-speed-table-v1334">
                ...
                <tbody>
                  ...
                  <tr><td data-label="Tee Box"><span className="tee-guide-name-v1335"><span className="tee-guide-square-v1335 tee-guide-black-v1335"/><strong>Tips</strong></span></td><td data-label="Driver Ball Speed">170+ mph</td><td data-label="Approx. Driver Carry">300+ yd</td><td data-label="Suggested Course Yardage">6,300–6,800+ yd</td></tr>
                </tbody>
              </table></div>
