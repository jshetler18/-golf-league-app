...
## v13.120
Reverted the League Admin desktop home to the prior layout: compact top header with logo/profile, with Administration / League Admin text and all admin buttons back below the header area. Keeps later login-centering and all other features.


## v13.128
- Fixed Admin Home inline workspace navigation so selected admin pages reliably load below the dashboard navigation.


## v13.129
- Restored stable desktop admin header alignment after inline workspace navigation.
- Logo remains top-left and profile remains pinned top-right on Admin Home and all admin subpages.
